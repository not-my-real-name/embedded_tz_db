...
namespace EmbeddedTimezoneDB
{
    public static class EmbeddedTzDB
    {
        ...
        /// This dictionary contains links between deprecated time zones (alias) and the current IANA zone name.
        /// The dictionary keys are the alias, and the value is the current canonical IANA zone name.
        public static Dictionary<string, string> IanaZoneLinks = new Dictionary<string, string>()
        {
            {"GMT", "Etc/GMT"},
